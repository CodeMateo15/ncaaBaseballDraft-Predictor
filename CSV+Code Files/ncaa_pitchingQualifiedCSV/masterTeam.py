...
pitching_path = os.path.join(base_dir, "PitchingDraftTable.csv")
...
# --- Step 1: Merge PitchingDraftTable with unique_teams on Acronym ---
pitching_merged = pitching.merge(unique_teams, on="Acronym", how="left")

# --- Step 2: Merge with team_name_mapping on Full Name ↔ team_new ---
pitching_merged = pitching_merged.merge(team_mapping, left_on="Full Name", right_on="team_new", how="left")

# --- Step 3: Merge with ncaabb_dataset on team_old ↔ team and year ---
final = pitching_merged.merge(
    ncaabb,
...
# --- Save result ---
output_path = os.path.join(base_dir, "PitchingDraftTable_with_teamstats.csv")
final.to_csv(output_path, index=False)
print("✅ Merged file saved as PitchingDraftTable_with_teamstats.csv")
