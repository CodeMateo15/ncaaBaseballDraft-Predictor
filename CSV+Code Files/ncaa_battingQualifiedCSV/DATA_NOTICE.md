...
This folder contained per-year FanGraphs **qualified** college-batting leaderboards (2021–2025) that the authors cannot redistribute under FanGraphs' terms of use. The CSVs are present in the authors' local working copy but are gitignored at the repo root.
